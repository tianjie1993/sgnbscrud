...
<body>
	<div class="search-area">
		...
		<div class="layui-form">	
			<div class="layui-form">
			  <table class="layui-table" lay-data="{height:500, url:'${basePath}/crud/list/sys_log', page:true,limit:100,limits:[100,200,500] ,id:'comontable'}" lay-filter="test">
		  <thead>
		    <tr>
		    		<th  lay-data="{field:'name', width:120, sort: true}">操作用户</th>
		    		<th  lay-data="{field:'actiondesc', width:250, sort: true}">操作描述</th>
		    		<th  lay-data="{field:'actiontime', width:200, sort: true}">操作时间</th>
		    </tr>
		  </thead>
		</table>
		</div>
