	...
	<div class="detail-page ">
		<div id="ztree" class="ztree"></div>
		    ...
		    <div class="layui-input-block">
		      ...
		      <button type="button" onclick="allotrole()" class="layui-btn layui-btn-small layui-btn-normal"> 确 定 </button>
		    </div>
		  </div>
		</div>
...
<script type="text/javascript">
	...
	function LoadTree(){
		...
		$.getJSON("${basePath}/role/LoadTree?id="+$("#userid").val(),function(data){
