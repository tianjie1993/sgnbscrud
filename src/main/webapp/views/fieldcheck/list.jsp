...
<body>
	<div class="search-area">
				...
				<form class="layui-form" action="">
				  <div class="layui-inline layui-form-sm">
				    ...
				    <div class="layui-input-inline">
				        <input id="tablename"   autocomplete="off" class="layui-input" type="text">
				    </div>
				  </div>
			...
			<div class="list-btns">
				<button class="layui-btn layui-btn-small layui-btn-primary" onclick="openwin('新建枚举项','/crud/tosave/fieldcheck','600px,500px','2','2')"><i class="layui-icon">&#xe654;</i>新增</button>
				<button class="layui-btn layui-btn-small layui-btn-primary" onclick="openwin('编辑枚举项','/crud/tosave/fieldcheck','600px,500px','2','1')"><i class="layui-icon">&#xe642;</i>修改</button>
				<button class="layui-btn layui-btn-small layui-btn-primary" onclick="ajaxreq('/crud/physicald/fieldcheck','1','1')"><i class="layui-icon">&#xe640;</i>删除</button>
			</div>
		</div>
			
		<div class="layui-form">	
			<div class="layui-form">
			  <table class="layui-table" lay-data="{height:500, url:'${basePath}/crud/list/fieldcheck', page:true,limit:10,limits:[10,50,100,200,500] ,id:'comontable'}" lay-filter="test">
		  <thead>
		    <tr>
		    	    <th lay-data="{checkbox:true}"></th>
		    		<th  lay-data="{field:'tablename', width:200, sort: true}">表名</th>
		    		<th  lay-data="{field:'fieldname', width:200, sort: true}">字段名</th>
		   		    <th  lay-data="{field:'eums', width:500, sort: true}">枚举项</th>
		    </tr>
		  </thead>
		</table>
		</div>
