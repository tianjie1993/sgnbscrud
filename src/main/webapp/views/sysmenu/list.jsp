...
<body>
	<div class="search-area">
			...
			<div class="list-btns">
				<button class="layui-btn layui-btn-small layui-btn-primary" onclick="openwin('新建菜单','/crud/tosave/sys_menu','1000px,500px','2','2')"><i class="layui-icon">&#xe654;</i>新增</button>
				<button class="layui-btn layui-btn-small layui-btn-primary" onclick="openwin('编辑菜单','/crud/tosave/sys_menu','1000px,500px','2','1')"><i class="layui-icon">&#xe642;</i>修改</button>
				<button class="layui-btn layui-btn-small layui-btn-primary" onclick="ajaxreq('/crud/physicald/sys_menu','1','1')"><i class="layui-icon">&#xe640;</i>删除</button>
			</div>
		</div>
			
		<div class="layui-form">	
			<div class="layui-form">
			  <table class="layui-table" lay-data="{height:500, url:'${basePath}/crud/list/sys_menu', page:true,limit:10,limits:[10,50,100,200,500] ,id:'comontable'}" lay-filter="test">
		  <thead>
		    <tr>
		    	    <th lay-data="{checkbox:true}"></th>
		    		<th  lay-data="{field:'id', width:80, sort: true}">主键</th>
		    		<th  lay-data="{field:'name', width:200, sort: true}">菜单名称</th>
		   		    <th  lay-data="{field:'url', width:200, sort: true}">地址</th>
		    		<th  lay-data="{field:'parentname', width:200, sort: true}">父级菜单</th>
