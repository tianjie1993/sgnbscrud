...
<body>
	...
	<div class="pagetit">系统菜单
		<c:if test="${empty entity.id}">新增</c:if>
		<c:if test="${not empty entity.id}">修改</c:if>
	</div>
	<form class="layui-form layui-w140" action="${basePath }/crud/save/sys_menu" method="post">
	<input name="id" type="hidden"  value="${entity.id}">
	<div class="detail-page">
		<div class="layui-row">
			<div class="layui-col-xs8 layui-col-sm6 layui-col-md6">
			    <label class="layui-form-label"><em class="must"></em>菜单名称：</label>
			...
			<div class="layui-col-xs8 layui-col-sm6 layui-col-md6">
			    ...
			    <div class="layui-input-block">
					<input name="url" value="${entity.url }"  class="layui-input" type="text">
			    </div>
			</div>
		</div>
		<div class="layui-row">
		<div class="layui-col-xs8 layui-col-sm6 layui-col-md6">
			<label class="layui-form-label"><em class="must"></em>父级菜单：</label>
			    <div class="layui-input-block">
					<select name="parentid" >
			    	 	<c:forEach items="${menus }" var="pmenu">
			    	 		<c:choose>
			    	 			<c:when  test="${pmenu.id eq entity.parentid}">
			...
			<div class="layui-col-xs8 layui-col-sm6 layui-col-md6">
				<label class="layui-form-label"><em class="must"></em>权限控制：</label>
			  	  <div class="layui-input-block">
					<select name="isshow">
			    	 	<c:forEach items="${entity.shows }" var="kv">
			    	 		<c:choose>
		...
		<div class="layui-row">
			...
			<div class="layui-col-xs8 layui-col-sm6 layui-col-md6">
			    ...
			    <div class="layui-input-block">
					<input name="icon" value="${entity.icon }"  class="layui-input" type="text">
		...
		<div class="layui-row">
		    <div class="layui-col-xs8 layui-col-sm6 layui-col-md6">
			    <label class="layui-form-label">菜单固定参数：</label>
			    <div class="layui-input-block">
					<input name="fixedprams" value="${entity.fixedprams }" placeholder="status=1,aa=rr" class="layui-input" type="text">
			    </div>
